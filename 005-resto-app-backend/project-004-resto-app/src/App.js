...
function App() {
  ...
  const reducer = (state, action) => {
    switch (action.type) {
      case "ADD_ITEM":
        axios
          .post("http://localhost:8080/forSaleItems", action.payload)
          .then((response) => {
      ...
      case "EDIT_ITEM":
        axios
          .put(
            `http://localhost:8080/forSaleItems/${action.payload.id}`,
            action.payload
          )
          .then((response) => {
            console.log(response);
        ...
        axios
          .put(
            `http://localhost:8080/cartItems/${action.payload.id}`,
            action.payload
          )
          .then((response) => {
            console.log(response);
      ...
      case "DELETE_ITEM":
        axios
          .delete(`http://localhost:8080/forSaleItems/${action.payload.id}`)
          .then((response) => {});
        return {
          ...state,
      ...
      case "ADD_TO_CART":
        ...
        axios
          .post("http://localhost:8080/cartItems", action.payload)
          .then((response) => {});
        return {
          ...state,
      ...
      case "DELETE_CART_ITEM":
        axios
          .delete(`http://localhost:8080/cartItems/${action.payload.id}`)
          .then((response) => {});
        return {
          ...state,
          cartItems: state.cartItems.filter(
      ...
      case "DECREMENT":
        axios
          .put(
            `http://localhost:8080/cartItems/decrementItem/${action.payload.id}`
          )
          .then((response) => {});
        return {
          ...state,
      ...
      case "INCREMENT":
        axios
          .put(
            `http://localhost:8080/cartItems/incrementItem/${action.payload.id}`
          )
          .then((response) => {});
        return {
          ...state,
